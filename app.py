...
@st.cache_data
def load_data():
    df = pd.read_csv("Frauddata_sampled.csv", low_memory=False)
    return df
...
try:
    ...
    st.success(f"Dataset loaded successfully! Shape: {df_sampled.shape}")
...
# ==========================================
st.header("2. Class Distribution (After 1:10 Balancing)")
...
with col2:
    counts = df_sampled['isFraud'].value_counts()
    ...
    ax.set_title('Class Distribution (1:10 Sampled)')
    st.pyplot(fig)
    plt.clf()
...
# ==========================================
st.header("6. Train-Test Split & Scaling")
...
# ==========================================
st.header("7. Logistic Regression")
...
# ==========================================
st.header("8. XGBoost (Base Model)")
...
# 9. Training PR Curve
# ==========================================
st.header("9. Training Precision-Recall Curve")
...
# ==========================================
st.header("10. Test Set Evaluation")
...
# 11. Tuned XGBoost
# ==========================================
st.header("11. Tuned XGBoost (Hyperparameter Tuning)")
